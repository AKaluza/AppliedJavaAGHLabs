  ...
  private static void printReport(TestExecutionSummary summary) {
    ...
    System.out.println(System.lineSeparator() +
            "------------------------------------------" + System.lineSeparator() +
                    "Tests started: " + summary.getTestsStartedCount() +System.lineSeparator() +
                    "Tests failed: " + summary.getTestsFailedCount() +System.lineSeparator() +
                    "Tests succeeded: " + summary.getTestsSucceededCount() +System.lineSeparator() +
                    "------------------------------------------"
    );
